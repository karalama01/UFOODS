...
export const translations = {
    en: {
        ...
        yasou: {
            ...
            items: {
                grapeLeavesJar: {
                    name: "Grape Leaves - Jar",
                    bt1: "1062cc",
                    bt2: "Drained: 452g",
                    type: "Pickled Grape Leaves",
                    imageAlt: "YASOU grape leaves",
                },
                grapeLeavesVaccum: {
                    name: "Grape Leaves - Vacuum Bag",
                    bt1: "Options:",
                    bt2: "350g / 700g",
                    type: "For practical transport and flexible shipping.",
    ...
    de: {
        ...
        yasou: {
            ...
            items: {
                grapeLeavesJar: {
                    name: "Weinblätter - Glas",
                    bt1: "1062cc",
                    bt2: "Abgetropft: 454 g",
                    type: "Eingelegte Weinblätter",
                    imageAlt: "YASOU Weinblätter",
                },
                grapeLeavesVaccum: {
                    name: "Weinblätter - Vakuumbeutel",
                    bt1: "Optionen:",
                    bt2: "350 g / 700 g",
                    type: "Für praktischen Transport und flexiblen Versand.",
    ...
    tr: {
        ...
        yasou: {
            ...
            items: {
                grapeLeavesJar: {
                    name: "Asma Yaprağı - Kavanoz",
                    bt1: "1062 cc",
                    bt2: "Kurutulmuş: 454g",
                    type: "Turşulanmış Üzüm Yaprakları",
                    imageAlt: "YASOU asma yaprağı",
                },
                grapeLeavesVaccum: {
                    name: "Üzüm Yaprakları - Vakumlu Torba",
                    bt1: "Seçenekler:",
                    bt2: "350g / 700g",
                    type: "Pratik taşıma ve esnek sevkiyat için.",
        ...
        contact: {
            ...
            form: {
                ...
                emailPlaceholder: "ahmetyilmaz@mail.com",
